...
def adjust_pictures(file_path: str, match: str, light_version: str, dark_version: str) -> None:
...
def add_version_to_selector_page(version: str) -> None:
    ...
    """
    indent = "        "
    new_line = f'{indent}<li><a href="https://emdgroup.github.io/octopus/{version}/">{version}</a></li>\n'
...
def adjust_version_to_html(version: str) -> None:
    ...
    link = "https://emdgroup.github.io/octopus/versions"
    new_line = f'{prefix}<a class={html_class} href="{link}">Version: {version}</a></li>'
    link_to_stable = '<a href="https://emdgroup.github.io/octopus/stable">stable</a>'
    # The content of the announcement that might be added.
    announcement = f"You are not viewing the documentation of the {link_to_stable} version."
