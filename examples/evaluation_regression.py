...
@app.cell(hide_code=True)
def _(chart, dropdown_exp_id, dropdown_seq_id, dropdown_split_id, mo):
    mo.vstack(
...
@app.cell(hide_code=True)
def _(alt, df_optuna, dropdown_exp_id, dropdown_seq_id, pl):
...
@app.cell(hide_code=True)
def _(chart_optuna_best_value, dropdown_exp_id, dropdown_seq_id, mo):
    mo.vstack(
...
@app.cell(hide_code=True)
def _(alt, df_optuna, dropdown_exp_id, dropdown_model, dropdown_seq_id, pl):
