...
# for mb+clhe
data_inventory = {
    6: "./datasets_local/LabValue/data_004_os6.csv",
    12: "./datasets_local/LabValue/data_004_os12.csv",
}
...
# features dict
feat_inventory = {
    "allquibim": "./datasets_local/LabValue/20241016_features_004_Quibim.csv",
}
...
for key, feature_file in feat_inventory.items():
    ...
    target_column = [f"OS{int(timepoint)}"]
    sample_column = "PatientID"
    stratification_column = [f"OS{int(timepoint)}"]  # "OS_DURATION_6MONTHS"
    ...
    config_study = ConfigStudy(
        name=f"OS{int(timepoint)}_004_OMORO_xgb_{dataset_key}",
