...
@Models.register("TabPFNClassifier")
def tabpfn_classifier() -> ModelConfig:
    """TabPFN classification model config."""
...
@Models.register("TabularNNClassifier")
def tabular_nn_classifier() -> ModelConfig:
    """Tabular neural network classification model config."""
    return ModelConfig(
