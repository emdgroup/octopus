...
def rf_class_parameters(trial, fixed_params=None, optuna_settings=None):
    """Suggest function for RF Classifier.
...
def rf_reg_parameters(trial, fixed_params=None, optuna_settings=None):
    """Suggest function for RF Regressor.
