...
file_path = "./datasets_local/baseline_dataframe_OS6_20240906A_mb_clhe_rad_3random(2-4)_treatmentarm(1)_strat.csv"  # OS6 rad+mb+clhe
...
##############Select features
features = pd.read_csv(  # rad + trmt
    "./datasets_local/20240906A_rad_mb_clhe_trmt_3noise.csv",
    index_col=0,
)
...
stratification_column = ["STRAT_OS6_TRT_NUM"]  # "OS_DURATION_6MONTHS"
...
config_study = ConfigStudy(
    name="MBOS6rad_4steps_rad_mb_clhe",
