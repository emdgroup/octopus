"""Workflow script for the california housing example."""

## Basic example for regression

# This example demonstrates how to use AutoGluon to create a ML regression model.
...
# 1. `ConfigStudy`: Sets the name, ML type (classification), and target metric.
